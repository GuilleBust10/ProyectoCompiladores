...
public class Nodo {
    ...
    public static final int TIPO_LIBRERIA=5;
    public static final int TIPO_INCLUIR=6;
    public static final int TIPO_COMENTARIO=7;
    ...
    public Nodo(int tipo, int valor) {
        ...
        switch (this.tipo) {
            ...
            case Nodo.TIPO_IDENTIFICADOR:
                break;
            case Nodo.TIPO_LIBRERIA:
                break;
            case Nodo.TIPO_COMENTARIO:
                break;
            case Nodo.TIPO_INCLUIR:
                break;
        }
    }
